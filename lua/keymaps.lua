...
map_nop('<C-h>', 'i') map_nop('<C-u>', 'i') map_nop('<C-o>', 'i')
map_nop('<C-x>', 'i') map_nop('<C-v>', 'i') map_nop('<C-k>', 'i')
map_nop('<C-t>', 'i') map_nop('<C-d>', 'i') map_nop('<C-a>', 'i')
map_nop('<C-y>', 'i') map_nop('<C-e>', 'i') map_nop('<C-s>', 'i')

map_nop('<C-1>', 'n') map_nop('<C-2>', 'n') map_nop('<C-3>', 'n')
map_nop('<C-4>', 'n') map_nop('<C-5>', 'n') map_nop('<C-6>', 'n')
map_nop('<C-7>', 'n') map_nop('<C-8>', 'n') map_nop('<C-9>', 'n')
map_nop('<C-0>', 'n') map_nop('<C-f>', 'n')
